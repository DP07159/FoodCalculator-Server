-- Permanente Produkt-/Nutzungsanalyse für Platform-Admins.
-- Es werden Produktinteraktionen, keine Inhaltskopien, protokolliert.
...
CREATE INDEX IF NOT EXISTS idx_product_events_workspace_created
...
VALUES ('migration_phase', '18-product-analytics', CURRENT_TIMESTAMP)
